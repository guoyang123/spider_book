...
> Request\(\)参数解释 1. url: 要下载的url 2. meta: 将img\_url作为参数传递给url页面 3. callback: url下载完成后，回调callback所定义的方法 4. dont\_filter: True 去重url
...
* 提取评论数、阅读数、点赞数
 ...
 这些数据异步加载，在原始html网页上并没有这些数据，需要模拟请求

![&#x8FD9;&#x662F;&#x56FE;&#x7247;](../.gitbook/assets/23.png)

1. 进入虚拟环境，安装requests库，模拟网络请求 ![&#x8FD9;&#x662F;&#x56FE;&#x7247;](../.gitbook/assets/24.png)
2. 进入python环境，使用requests ![&#x8FD9;&#x662F;&#x56FE;&#x7247;](../.gitbook/assets/25.png)
3. 将json字符串转对象

   ![&#x8FD9;&#x662F;&#x56FE;&#x7247;](../.gitbook/assets/26.png)
...
> 注意： 上面的代码中，因为获取点赞、评论等是异步加载，因此需要将文字标题、内容等数据传递给data\_parse函数。
...
* step2 在settings.py中设置图片保存路径IMAGE\_STORE
